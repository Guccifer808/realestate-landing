          ...
          <div className="w-full  lg:w-1/2 xl:w-6/12">
            ...
            >
              ...
              <h1 className="text-2xl font-bold text-dark-100 sm:text-3xl">
                Позвольте нам стать вашим надежным проводником в новую жизнь в
                Испании, Коста дель Соль!
              </h1>
              <p className="max-w-2 mx-auto mt-10 text-dark-100">
                Предлагаем вам заглянуть в этот уникальный мир, где каждое видео
                из нашего райского местечка - это окно в жизнь, наполненную
                вдохновением, красотой и удивительными историями.
                <br /> Откройте для себя эту великолепную эстетику и стиль,
                ощутите сказочную атмосферу и эмоции жизни на побережье - от
                чудесных пейзажей и солнечного климата, до гастрономии, арта и
                культуры.
              </p>
